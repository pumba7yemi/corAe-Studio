  ...
  return (
    <div className="p-6 font-sans">
      ...
      <div className="grid gap-4 mt-4 md:grid-cols-3">
        <form action={enqueueSelfTest} className="rounded-2xl border border-ring bg-card p-4 shadow-card">
        ...
        <form action={devPassChecks} className="rounded-2xl border border-ring bg-card p-4 shadow-card">
        ...
        <form action={builderConfirm} className="rounded-2xl border border-ring bg-card p-4 shadow-card">
