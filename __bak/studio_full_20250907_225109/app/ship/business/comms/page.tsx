// apps/studio/app/ship/business/comms/page.tsx
export default function BusinessComms() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-bold">corAe Comms™</h1>
      <p className="text-gray-600">Emails inbox, OBARI feed, 3³DTD triage, and CIMS queue.</p>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Tile href="/ship/work"    title="3³DTD"  desc="Triage → Decide → Do" />
        <Tile href="/ship/business/oms/obari" title="OBARI" desc="Lifecycle dashboard" />
      </div>
    </div>
  );
}