...
export const metadata = {
  title: "Main Catholic Prayers – corAe Faith Library",
  description:
    "Complete set of foundational Catholic prayers: Our Father, Hail Mary, Glory Be, Creed, Act of Contrition, and more.",
};
