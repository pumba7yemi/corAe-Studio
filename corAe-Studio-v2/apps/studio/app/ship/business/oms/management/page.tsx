...
export default function ManagementCockpit() {
  const areas = [
    { href: 'caia', title: 'CAIA', desc: 'AI executive assistant â€” inbox, diary, follow-ups' },
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <p className="text-sm opacity-70">
        Central view for managers + CAIA â€” finance, ops, assistant tools, and scheduling.
      </p>
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {areas.map(i => (
          <Link
            key={i.href}
            href={`/business/oms/management/${i.href}`}
