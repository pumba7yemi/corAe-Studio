...
export default function GlamGlowPage() {
  ...
  return (
    <HomeSectionLayout title="Home • Glam & Glow" hint="Skincare, haircare, appointments">
      <Card title="Care List">
        <div className="flex gap-2">
          <Input placeholder="e.g., Book trim this Friday" value={text} onChange={e=>setText(e.target.value)} />
