...
async function seedApis(s:HomeState){
  try{await fetch("/api/home/routines",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:"seedFromBlueprint",blueprint:JSON.parse(s.blueprintJson||"{}")})});}catch{}
  try{await fetch("/api/home/haveyou",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:"bulkUpsert",items:s.reminders})});}catch{}
}
