...
import { applySchemaPatch } from "./patchers/schemaPatcher";
import { runGuards } from "./guards/runGuards.js";
...
async function ensureFs() {
  ...
  try { await fs.access(JOBS_FILE); } catch { await fs.writeFile(JOBS_FILE, "[]", "utf8"); }
}
