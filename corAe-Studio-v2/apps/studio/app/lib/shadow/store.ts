// apps/studio/app/lib/shadow/store.ts
...
declare global {
  ...
  var __CORAE_SHADOW_STORE__: ShadowStore | undefined;
}
...
const STORE: ShadowStore = (globalThis.__CORAE_SHADOW_STORE__ ??= makeStore());
